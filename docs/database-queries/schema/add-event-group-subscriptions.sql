-- Event Group Subscriptions Schema
...
-- Anyone can view subscription counts and subscriber lists (for public group pages)
CREATE POLICY "Anyone can view subscriptions for public display"
  ON event_group_subscriptions
  FOR SELECT
  USING (true);
