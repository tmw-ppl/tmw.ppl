    ...
    <>
        ...
        <div className="container">
          <AnimatedSection animationType="fade">
            ...
            <p className="section-sub">
              A living playground for curious minds. We host hands-on
              gatherings, build small products, share skills, and support each
              other. The goal is simple. Become better creators. Make things we
              are proud of. Have more fun doing it with friends.
            </p>
          </AnimatedSection>
          <div className="feature-grid">
            <AnimatedSection animationType="scale" delay={100}>
              <Card className="float-animation">
                ...
                <h4>Creativity</h4>
                <p>
                  Workshops, show and tell nights, open studio days, and a
                  steady flow of small bets that sharpen your craft.
                </p>
              </Card>
            </AnimatedSection>
            <AnimatedSection animationType="scale" delay={200}>
              <Card className="float-animation-reverse">
                ...
                <h4>Technology</h4>
                <p>
                  AI tools, web experiments, robotics play, and practical skill
                  sharing that turns ideas into working things.
                </p>
              </Card>
            </AnimatedSection>
            <AnimatedSection animationType="scale" delay={300}>
              <Card className="float-animation">
                ...
                <h4>Community</h4>
                <p>
                  Dinners, poolside jams, sunrise hikes, and collaborative
                  builds that turn strangers into friends.
                </p>
              </Card>
            </AnimatedSection>
          </div>
      ...
      <section id="pillars">
        <div className="container">
          ...
          <p className="section-sub">
            Show up. Ship small. Share what you learn. Lift others. Leave things
          ...
          <div className="feature-grid">
            <Card>
              ...
              <h4>Show up</h4>
              <p>
                Everything good starts with people in the same room. We bias for
                action and presence.
              </p>
            </Card>
            <Card>
              ...
              <h4>Ship small</h4>
              <p>
                Small bets compound. We celebrate scrappy wins and momentum over
                perfection.
              </p>
            </Card>
            <Card>
              ...
              <p>
                We swap notes, give feedback, and create opportunities for each
                other. Success is a team sport.
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="container">
          <div className="cta">
            <div>
              ...
              <p>
                Create your account to access exclusive events, connect with the
                community, and be part of the Tomorrow People movement.
              </p>
            </div>
            <div style={{ display: 'grid', gap: '10px' }}>
