  ...
  const filterProfiles = () => {
    ...
    if (searchTerm.trim()) {
      ...
      filtered = filtered.filter((profile) => {
        const searchableText = `${profile.name} ${profile.role} ${
          profile.bio
    ...
    if (activeFilter !== 'all') {
      filtered = filtered.filter((profile) => {
        const searchableData =
          `${profile.skillsData} ${profile.interestsData}`.toLowerCase()
        ...
        <div className="profiles" id="profiles-container">
          {filteredProfiles.map((profile) => (
            <div
              ...
              data-skills={profile.skillsData}
              data-interests={profile.interestsData}
            >
              ...
              <div className="profile-content">
                ...
                <div className="profile-actions">
                  ...
                  <Button
                    variant="secondary"
                    onClick={() => handleViewProfile(profile.name)}
                  >
                    View Profile
                  </Button>
                </div>
