    ...
    return (
      <section className="hero">
        <div className="container">
          ...
          <p className="lead">Hands-on nights, rooftop jams, show-and-tells, and pop-up collabs. Add them to your calendar and come say hi.</p>
      ...
      <div className="container">
        ...
        <AnimatedSection animationType="slide-up" delay={200}>
          <div className="filters" aria-label="Filters">
            ...
            {user && (
              <Link to="/create-event" className="btn primary" style={{marginLeft: '20px'}}>
                Create Event
              </Link>
            )}
          </div>
